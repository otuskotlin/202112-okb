package ru.otus.otuskotlin.structuredconcurency

import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.async
import kotlinx.coroutines.coroutineScope
import structuredconcurency.Vocabulary
...
suspend fun findWordsAsync(vocabulary: Vocabulary, word: String, word2: String, coroutineScope: CoroutineScope) {
    val deferred = coroutineScope.async { vocabulary.find(word) }
    val deferred2 = coroutineScope.async { vocabulary.find(word2, withTime = 5000) } // Resume (with GlobalScope)
